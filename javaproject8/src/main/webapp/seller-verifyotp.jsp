        ...
        <form action="Server" method="post"> 
                   ...
                   <%int otp = (Integer) request.getAttribute("otp"); %>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="login-form" action="Server" methoe="post">
                            <div class="row">
                         
                                <div class="col-md-6">
                                    
                                    <input class="form-control" type="hidden" value="<%=email %>"  name="email">
                                </div>
                              
                                <div class="col-md-6">
                                    
                                    <input class="form-control" type="hidden" value=<%=otp %> name="otp">
                                </div>
                                <div class="col-md-6">
                                    <label>OTP</label>
                                    <input class="form-control" type="text"  name="otp2">
                                </div>
                                <div class="col-md-12">
