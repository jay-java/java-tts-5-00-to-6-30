                        ...
                        <div class="navbar-nav mr-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="login.jsp" class="dropdown-item active">Seller-Register</a>
				...
				<%} %>
                    ...
                    <div class="col-lg-6">
                     <%String email = (String)request.getParameter("email"); %>
                        <div class="login-form" action="Server">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="text" placeholder="confirm  Password" name="cnp">
                                </div>
                              <!--   <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                   <input type="submit" value="new password" name="action">
                                </div>
                               <!--   <div class="col-md-6">
