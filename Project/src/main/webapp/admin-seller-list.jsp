		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="mt"><a class="active" href="admin-index.jsp"> <i
							class="fa fa-dashboard"></i> <span>Dashboard</span>
					</a></li>

					<li class="sub-menu"><a href="admin-seller-list.jsp"> <i
							class="fa fa-desktop"></i> <span>Sellers</span>
					</a></li>
					...
					<li class="sub-menu"><a href="admin-product-list.jsp"> <i
							class="fa fa-book"></i> <span>Products</span>
					</a></li>
								...
								<table
									...
									<tbody>
										...
										<tr>
											<td><%=s.getId() %></td>
											<td><%=s.getName() %></td>
											<td class="numeric"><%=s.getContact() %></td>
											<td class="numeric"><%=s.getAddress() %></td>
											<td class="numeric"><%=s.getEmail() %></td>
											<td class="numeric"><%=s.getPassword() %></td>
											<td class="numeric"><a href="admin-single-seller.jsp?id=<%=s.getId()%>">Edit</a></td>
											<td class="numeric"><a href="admin-single-seller-delete.jsp?id=<%=s.getId()%>">Delete</a></td>
										</tr>
								<%} %>
									</tbody>
								</table>
