	  ...
	  <div class="header_bottom">
	   <div class="logo">
	     ...
	     <li><a class="color10" href="seller-index.jsp">Home</a></li>
			<li><a class="color2" href="#">Upload Product</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
			...
			<li><a class="color2" href="#">Manage Product</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
				...
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
								<h4><a href="seller-profile.jsp">Profile</a></h4>
							</div>							
						</div>
						<div class="col1">
							<div class="h_nav">
								<h4><a href="seller-change-password.jsp">Change Password</a></h4>
							</div>							
						</div>
						<div class="col1">
							<div class="h_nav">
								<h4><a href="seller-logout.jsp">Logout</a></h4>
							</div>							
						</div>
			...
			<div class="contact_form">
				<form action = "SellerController" method="post">
					<div class="col-md-12 to">
						...
						<input type="text" class="text" name="name" value="<%=s.getName()%>"> 
						<input type="text" class="text" name="contact" value="<%=s.getContact()%>"> 
						<input type="text" class="text" name="address" value="<%=s.getAddress()%>"> 
						<input type="text" class="text" name="email" value="<%=s.getEmail()%>">
					</div>
					<div class="clearfix"></div>
