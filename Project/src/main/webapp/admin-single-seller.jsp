				...
				<div class="row mt">
					<div class="col-lg-6">
						<div class="form-panel">
							...
							<form action="SellerController" class="form-horizontal style-form" method="post">
							<input type="hidden" name="id" value="<%=s.getId()%>">
								...
								<button type="submit" class="btn btn-theme" name="action" value="aupdate">Update</button>
							</form>
						</div>
					</div>
					<!-- col-lg-12-->
